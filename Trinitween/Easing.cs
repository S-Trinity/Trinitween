...
namespace Trinitween
{
    ...
    public static class Easing
    {
        ...
        public static float Ease(EaseType type, float from, float to, float t, AnimationCurve curve = null)
        {
            switch (type)
            {
                case EaseType.Linear:
                    return LinearM(from, to, t);
                ...
                case EaseType.Custom:
                    return CustomCurve(from, to, t, curve);
            }
        ...
        public static float LinearM(float from, float to, float t)
        {
        ...
        public static float CustomCurve(float from, float to, float t, AnimationCurve curve)
        {
            if (curve == null)
            {
                Debug.Log("No Animation Curve given to Tween function");
                return 0;
            }
            else
                return Custom(t, from, to, curve);
        }
        ...
        private static float Custom(float t, float from, float to, AnimationCurve curve, float d = 1)
        {
            return (to - from) * curve.Evaluate(t) + from;
        }
